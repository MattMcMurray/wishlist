...
class WishlistItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create wishlist_item" do
    assert_difference("WishlistItem.count") do
      post wishlist_items_url, params: { wishlist_item: { description: @wishlist_item.description, title: @wishlist_item.title, url: @wishlist_item.url } }
    end
  ...
  test "should update wishlist_item" do
    patch wishlist_item_url(@wishlist_item), params: { wishlist_item: { description: @wishlist_item.description, title: @wishlist_item.title, url: @wishlist_item.url } }
